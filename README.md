...
- **Facturation par abonnement (SaaS)** — chaque centre a un essai gratuit de 30 jours puis un `Plan` payant ; cron quotidien qui facture, relance par email (J-7/J-5/J-3/impayé), et bloque l'accès (402 `SUBSCRIPTION_INACTIVE`) aux routes patients/consultations/registres si l'abonnement tombe en `PAST_DUE`/`CANCELED`.
