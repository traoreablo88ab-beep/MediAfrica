...
// imported by tests. pathToFileURL normalizes Windows backslashes /
// drive-letter URIs; a naive `file://${process.argv[1]}` string never
// matches import.meta.url on Windows, so this guard would silently no-op.
