// POST /api/registres/consultation/close — manually close a month's
// consultation register. Any authenticated staff member can close (no
// ADMIN gate — matches the rest of Patients/Consultations, not back-office).
// Once closed, Consultation mutation routes for that month refuse with
// REGISTER_CLOSED (see lib/server/registers/closure.ts).
...
const REGISTER_TYPE = 'consultation';
