// POST /api/registres/laboratoire/close — manually close a month's
// Laboratoire register. Any authenticated staff member can close (no ADMIN
// gate — matches the rest of Patients/Consultations, not back-office). Once
// closed, PUT /api/registres/laboratoire refuses further edits for that
