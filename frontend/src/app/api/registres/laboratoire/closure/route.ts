// GET /api/registres/laboratoire/closure?month=2026-01 — closure status for
// a given month (default: current month) of the Laboratoire register. Any
// authenticated staff member can read this (used to show the "Clôturé"
// badge / gate the save button and the close button).
