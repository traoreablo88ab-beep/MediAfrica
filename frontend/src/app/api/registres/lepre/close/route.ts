// POST /api/registres/lepre/close — manually close a month's Lèpre register.
// Any authenticated staff member can close (no ADMIN gate — matches the
// rest of Patients/Consultations, not back-office). Once closed, PUT
// /api/registres/lepre refuses further edits for that month with
