// POST /api/registres/maternite/accouchement/close — manually close a month's Accouchement
...
// closed, POST /api/patients/[id]/maternite refuses new Accouchement entries for
...
const REGISTER_TYPE = 'maternite-accouchement';
