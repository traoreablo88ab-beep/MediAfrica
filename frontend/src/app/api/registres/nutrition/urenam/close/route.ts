// POST /api/registres/nutrition/urenam/close — manually close a month's
// URENAM register. Any authenticated staff member can close (no ADMIN gate —
// matches the rest of Patients/Consultations, not back-office). Once
// closed, POST /api/patients/[id]/nutrition refuses new URENAM entries for
// that month with REGISTER_CLOSED (see lib/server/registers/closure.ts).
// Closing this register does not affect URENI/URENAS.
...
const REGISTER_TYPE = 'nutrition-urenam';
