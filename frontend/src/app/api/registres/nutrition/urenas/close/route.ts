// POST /api/registres/nutrition/urenas/close — manually close a month's
// URENAS register. Any authenticated staff member can close (no ADMIN gate —
// matches the rest of Patients/Consultations, not back-office). Once
// closed, POST /api/patients/[id]/nutrition refuses new URENAS entries for
// that month with REGISTER_CLOSED (see lib/server/registers/closure.ts).
// Closing this register does not affect URENI/URENAM.
...
const REGISTER_TYPE = 'nutrition-urenas';
