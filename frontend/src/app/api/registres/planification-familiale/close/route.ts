// POST /api/registres/planification-familiale/close — manually close a
// month's planification familiale register. Any authenticated staff member
// can close (no ADMIN gate — matches the rest of Patients/Consultations,
// not back-office). Once closed, POST
// /api/patients/[id]/planification-familiale refuses new entries for that
