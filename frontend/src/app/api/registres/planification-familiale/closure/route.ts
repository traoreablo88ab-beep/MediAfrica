// GET /api/registres/planification-familiale/closure?month=2026-01 —
// closure status for a given month (default: current month) of the
// planification familiale register. Any authenticated staff member can
// read this (used to show the "Clôturé" badge / gate the close button).
