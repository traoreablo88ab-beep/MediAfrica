// POST /api/registres/ressources/close — manually close a month's Ressources
// register. Any authenticated staff member can close (no ADMIN gate — same
// as every other register). Closes the shared registerType 'ressources',
// which locks the sibling personnel/equipement/visites sub-resources too
// (they all check isMonthClosed against the same registerType).
