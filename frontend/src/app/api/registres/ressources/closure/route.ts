// GET /api/registres/ressources/closure?month=2026-01 — closure status for a
// given month (default: current month) of the shared Ressources register
// (registerType 'ressources', covers the flat record + personnel/equipement/
// visites sub-resources together).
