// POST /api/registres/vaccination/close — manually close a month's
// vaccination register. Any authenticated staff member can close (no ADMIN
// gate — matches the rest of Patients/Consultations, not back-office). Once
// closed, POST /api/patients/[id]/vaccination refuses new entries for that
